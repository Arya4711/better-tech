package io.github.Sapender.RahoodTech.Initialisation.tiers;
...
public class ModArmourMaterial implements ArmorMaterial {
    ...
    public ModArmourMaterial(int[] durabilityForType, int[] defenseForType, int enchantability, SoundEvent equipSound, Supplier<Ingredient> repairMaterial, String name, float toughness, float knockbackResistance) {
